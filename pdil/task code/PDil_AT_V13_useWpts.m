...
BlockNumber = '4'; %set to zero for practice block
  
opponent = 'computer'; %either 'human' or 'computer'; %This is f or purposes of the display screen only, you need to change the 'strategy' variable below if you actually wanna have a personVperson game
...
if strcmp(practiceblock, 'yes')
    nTrialsPerBlock = 6; %AT changed to 6 on 6/30/20 as it was taking too long w/ 8.
...
taskoutput = struct();
dbstop if error
% Screen('Preference', 'SkipSyncTests', 1); %set to '1' to skip the error screen  
PsychDefaultSetup(2);
